LICENSE AND COMMERCIAL TERMS OF USE
...
1. CONVERSION AND PORTING RESTRICTION
STRICTLY PROHIBITED: Porting, converting, or translating this parsing logic, scripts, or any parts thereof into the C# (C-Sharp) programming language or any .NET-based framework without explicit written permission from github Mr-Luckyowl is strictly forbidden.
...
7. PORTING to C# is forbidden without LICENSE
see 6. to contact.
